...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url();?>/css/admin/bootstrap-msg.css" rel="stylesheet">
    <!-- Font Awesome -->
      ...
      <div class="main_container">
        ...
        <div class="col-md-3 left_col">
          ...
          <div class="navbar nav_title" style="border: 0;">
              <a href="<?=base_url();?>/admin" class="site_title"><img class="logo img-responsive desklogo" src="<?php echo base_url();?>/images/logo.jpg" alt="Sun Pharma Science Foundation" /><img class="logo img-responsive mobilelogo" src="<?php echo base_url();?>/images/logo-mini.svg" alt="Sun Pharma Science Foundation" /></a>
            </div>
