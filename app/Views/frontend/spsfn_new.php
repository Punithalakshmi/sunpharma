                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <div class=" mb-3 form-items">
                                    ...
                                    <input class="form-control required" data-provide="datepicker" id="date_of_birth_spsfn" name="date_of_birth" value="<?=set_value('date_of_birth',$editdata['date_of_birth']);?>" placeholder="MM/DD/YYYY">
                                    <div class="hintcont">
                                        <small class="form-label "><b>Date Format: MM/DD/YYYY (Age should be less than 30 years as on July 01, <?=date("Y");?>)</b></small>
                                    </div>
