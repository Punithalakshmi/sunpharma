    ...
    <section class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>The Research Awards aim to recognise and reward Indian scientists in India and abroad who have excelled in Medical and Pharmaceutical Sciences Every year the Foundation invites nominations for three awards – two in Medical Sciences (one each in Basic and Clinical research) and  one in Pharmaceutical Sciences. These nominations are evaluated by a panel of judges comprising eminent scientists. Each award carries a trophy, citation and a cash award of  INR 2,50,000. The awards are presented by a distinguished scientist.<br></p>
                </div>
            </div>
        </div>
        <div class="container">
                ...
                <div class="col-md-6">
                    <ul class="list-group btnaction" style="max-width: 400px;border-color: var(--bs-blue);">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor" style="font-size: 29px;color: var(--theme-orange);">
                            ...
                            <a href="https://sunpharmasciencefoundation.net/documents/Scope%20of%20the%20Award.pdf" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;" target="_blank">Scope of each Award</a></li>
                        <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);">
                            ...
                            <a href="https://sunpharmasciencefoundation.net/documents/RA_Nomination_2021.doc" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;" target="_blank">Nomination Procedure</a></li>
                        <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);">
                         ...
                         <a href="<?=base_url();?>/directory_research_awardees" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;">Directory of Previous Awardees</a></li>
                    </ul>
                </div>
