    <section class="heroInner" style="background: #fff url(<?=base_url();?>/frontend/assets/img/ResearchAwards-tbanner.jpg) center left no-repeat;">
        <div class="container">
            <h1 class="fs-1 fw-bold text-capitalize fw-normal p-3 m-0 d-inline-block" style="color: var(--theme-orange);">Research Fellowships</h1>
        </div>
    </section>
    <section class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p style="text-align:justify;">The Research Fellowships aim to recognise and reward Indian scientists in India and abroad who have excelled in Medical and Pharmaceutical Sciences Every year the Foundation invites nominations for three fellowships – two in Medical Sciences (one each in Basic and Clinical research) and  one in Pharmaceutical Sciences. These nominations are evaluated by a panel of judges comprising eminent scientists. Each fellowship carries a trophy, citation and a cash prize of  INR 2,50,000. The fellowships are presented by a distinguished scientist.<br></p>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <ul class="list-group btnaction" style="max-width: 400px;border-color: var(--bs-blue);">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor" style="font-size: 29px;color: var(--theme-orange);">
                            ...
                            <a href="https://sunpharmasciencefoundation.net/documents/Scope of the SPSF RF 2024.pdf" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;" target="_blank">Scope of each Fellowship</a></li>
                        <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);">
                            ...
                            <a href="https://sunpharmasciencefoundation.net/documents/Nomination Procedure - RF 2024 (For website update).pdf" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;" target="_blank">Nomination Procedure</a></li>
                        <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);">
                         ...
                         <a href="<?=base_url();?>/directory_research_awardees" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;">Directory of Previous Winners</a></li>
                    </ul>
                </div>
                <div class="col-md-6 align-items-center align-items-sm-center">
                    <?php
                       ...
                       {
                           $url = base_url().'/ssan/18'; 
                           $view = (!isset($userdata['isLoggedIn']) && (is_array($currentNominations) && $currentNominations['research_awards'] == 'yes'))?true:false;
                       }    
                       if($view)
                       {
                    ?>
            ...
            <section class="border tabWrapper">
                        <div class="tabFilter">
                            <ul class="nav nav-tabs bg-orange pt-3 px-3" role="tablist">
                                <li class="nav-item" role="presentation"><a class="nav-link active" role="tab" data-bs-toggle="tab" href="#tab-1">Pharmaceutical Sciences</a></li>
                                <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-bs-toggle="tab" href="#tab-2">Medical Sciences-Basic Research</a></li>
                                <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-bs-toggle="tab" href="#tab-3">Medical Sciences-Clinical Research</a></li>
                            </ul>
...
<h2>Medical Sciences-Clinical Research</h2>
<!-- <p>Dummy textt of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
</p> -->
