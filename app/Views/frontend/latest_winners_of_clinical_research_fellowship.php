    <section class="heroInner" style="background: url(<?=base_url();?>/frontend/assets/img/latest_winners_of_science_scholar_awards-tbanner.jpg) center left no-repeat, #fff;">
        <div class="container">
            <h1 class="fs-1 fw-bold fw-normal p-3 m-0 d-inline-block" style="color: var(--theme-orange);">Latest Winners Of Clinical Research Fellowships<br></h1>
        </div>
    </section>
    <section class="py-5">
        <div class="container">
        ...
        <div class="container" style="margin-bottom: 60px;">
            <div class="row">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h3 class="heading" style="color: #F7941E;">2023 & <?=date('Y')-1;?></h3>
                </div>
            </div>
            ...
            <?php if(is_array($latestWinnersOfClinicalResearchFellowship) && count($latestWinnersOfClinicalResearchFellowship) > 0 ): 
                        foreach($latestWinnersOfClinicalResearchFellowship as $wkey => $wvalue):
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?=$wvalue['name'];?><br></h4>
                    ...
                    <div class="container">
                        <div class="row" style="margin-bottom: 15px;">
                            <div class="col-md-6 col-lg-3">
                                <img class="img-fluid mb-3 fit-cover rounded-3" src="<?=base_url();?>/uploads/winners/<?=$wvalue['photo'];?>" style="width: 150px;height: 150px;"></div>
                            <div class="col-md-6 col-lg-9">
                                <p class="fw-bold"><?=$wvalue['name'];?><br></p>
