...
<section class="bg-primary-gradient"><!-- CONTAINER -->
    <div id="mainform-container" class="container py-1 <?php if(isset($user['is_submitted']) && ($user['is_submitted'] == 1)){ ?>preview<?php } ?>">
    ...
    <div class="row">
       ...
       if(isset($userdata['nominationEndDays']) && $userdata['nominationEndDays'] <= 0): ?>
        ...
        <div id="mainform-items" class="col-lg-12 mx-0 px-0">
            ...
            <form method="post" name="nomination_data" action="<?=base_url();?>/applicant/view" enctype="multipart/form-data">
		...
		//print_r($user); 	die;	
            ...
            <input type="hidden" name="id" value="<?=(isset($editdata['id']) && !empty($editdata['id']))?$editdata['id']:"";?>" />
				 ...
				 <?php endif; if($user['is_submitted'] == 0 && $user['is_carry_forwarded'] == 1): ?> 
                                  <div class="col-lg-12">
                                    <div class="mb-3 form-items">
                              ...
                              <?php endif; 
						if($user['is_submitted'] == 0 && $user['is_carry_forwarded'] == 1 && $user['citizenship']!=1): ?> 
                                  <div class="col-lg-12">
                                    <div class="mb-3 form-items">
                                       <input class="form-control required" name="passport" type="file" id="passport" value="<?=$editdata['passport'];?>" accept="application/pdf">
					  ...
					  <div class="hintcont">
                                ...
                                <?php endif;
					if($user['is_submitted'] == 0 && $user['is_carry_forwarded'] == 1): ?> 
                                  <div class="col-lg-12">
