...
<footer class="bg-primary-gradient" style="background: #5c5c5c;">
        <div class="container py-4 py-lg-5">
			...
			<li style="color: var(--bs-white);font-size: 14px;"><a class="dropdown-item" href="<?=base_url();?>/latest_winners_of_clinical_research_fellows">Latest Winners Of Clinical Research Fellowships</a></li>
