...
<div id="overlay">
  ...
  <?php if( $uri !='login'): ?>
    <nav class="navbar navbar-light navbar-expand-md sticky-top" id="mainNav" style="padding: 0;">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?=base_url();?>" style="min-width: 300px;">
                <span>
                    <img src="<?=base_url();?>/frontend/assets/img/logo-dark.svg" height="120" style="object-fit: cover;">
                </span>
            </a>
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <div class="nav-item dropdown nav-link">
                            <a class="dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" href="awards.html">Awards</a>
                    ...
                    <li class="nav-item">
                        <div class="nav-item dropdown nav-link"><a class="dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" href="<?=base_url();?>/annual_activities">Key Activities</a>
                            <div class="dropdown-menu">
                    ...
                    <li class="nav-item">
                        <div class="nav-item dropdown nav-link">
                            <a class="dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" href="#">Directory</a>
                            <div class="dropdown-menu">
