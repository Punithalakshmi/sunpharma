    ...
    <section class="heroInner" style="background: #fff url(<?=base_url();?>/frontend/assets/img/directory-Scholars.jpg) center left no-repeat;">
        <div class="container">
            <h1 class="fs-1 fw-bold text-capitalize fw-normal p-3 m-0 d-inline-block" style="color: var(--theme-orange);">Science Scholar Fellowship Winners<br></h1>
        </div>
    </section>
    <section class="py-5">
        <div class="container">
        ...
        <?php if(is_array($awardees)): 
               foreach($awardees as $akey=>$avalue):  $column = (count($avalue)>0 && count($avalue) <=4)?'4':5; ?>        <div class="container olddirectory">
            <div class="row">
