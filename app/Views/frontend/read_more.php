<section class="heroInner" style="background: #fff url(<?=base_url();?>/uploads/events/<?=$eventData['banner_image'];?>) center left no-repeat;">
        <div class="container">
            <h1 class="fs-1 fw-bold text-capitalize fw-normal p-3 m-0 d-inline-block" style="color: var(--theme-orange);"><?=($eventData['title'])?$eventData['title']:'';?></h1>
        </div>
    </section>
    <section class="py-5">
        <div class="container">
                ...
                <div class="col-md-6">
                    ...
                    <ul class="list-group btnaction" style="max-width: 400px;border-color: var(--bs-blue);">
                        ...
                        <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);">
                         ...
                         <a href="<?=base_url();?>/event/registration" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;">Registration</a></li>
                    </ul>
                </div>
