...
<?php } ?>
 <?php if(!empty($uri_value) && ($uri_value !=15)){?>
				 <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);">
                            ...
                            <a href="<?=base_url();?>/uploads/events/Write_up_on_PDMFE.pdf" target="_blank" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;" target="_blank">Write up on PDMFE</a></li>
<?php } ?>

			<!-- <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-64 0 512 512" width="1em" height="1em" fill="currentColor" class="fa-2x" style="font-size: 26px;color: var(--theme-orange);">
                                                            </svg>
                            <a href="<?//base_url();?>/uploads/events/Flyer_Molecular_Diagnostics.pdf" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;" target="_blank">Flyer</a></li>-->
