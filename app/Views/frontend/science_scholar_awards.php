<section class="heroInner" style="background: url('<?=base_url();?>/frontend/assets/img/science-scholar-award-tbanner.jpg') top no-repeat, #fff;">
        <div class="container">
            <h1 class="fs-1 fw-bold text-capitalize fw-normal p-3 m-0 d-inline-block" style="color: var(--theme-orange);">Science Scholar Fellowships</h1>
        </div>
    </section>
    <section class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p style="text-align:justify;">The Science Scholar Fellowships for Young Scientists aims to discover brilliant and upcoming young researchers in Bio-medical and Pharmaceutical Sciences. These fellowships are meant to stimulate the young minds to pursue research as a career by way of soliciting commitment for the cause of future advancement of science. Each Science Scholar Fellowship carry a certificate and a Cash Prize of Rupees fifty thousand. In addition to this, rupees fifty thousand will be provided to the science scholar fellows for attending an international conference to present abstracts/Posters. To avail this additional amount, the fellows should submit the invitation letter from the conference organizing committee and also expense details with documentary proof to the office of the foundation.<br></p>
                ...
                <div class="col-md-6">
                    <ul class="list-group btnaction" style="max-width: 400px;border-color: var(--bs-blue);">
                        <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-64 0 512 512" width="1em" height="1em" fill="currentColor" class="fa-2x" style="font-size: 26px;color: var(--theme-orange);">
                            ...
                            </svg><a href="https://sunpharmasciencefoundation.net/documents/Scholar Fellowship - Eligibility & Nomination Procedure 2024.pdf" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;" target="_blank">Eligibility and Nomination Procedure</a></li>
                        <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor" class="fa-2x" style="font-size: 26px;color: var(--theme-orange);">
                            ...
                            </svg><a href="<?=base_url();?>/directory_of_science_scholars" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;">Directory of Previous Winners</a></li>
                    </ul>
                </div>
                <?php
                         $view = true;
