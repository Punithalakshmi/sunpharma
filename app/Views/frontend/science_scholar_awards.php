<section class="heroInner" style="background: url('<?=base_url();?>/frontend/assets/img/science-scholar-inner.jpg') top no-repeat, #fff;">
        <div class="container">
            <h1 class="fs-1 fw-bold text-capitalize fw-normal p-3 m-0 d-inline-block" style="color: var(--theme-orange);">Awards/Scholar Awards</h1>
        </div>
    </section>
    <section class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-capitalize fw-normal" style="color: var(--theme-orange);">Science Scholar Awards</h3>
