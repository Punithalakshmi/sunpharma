	  ...
	  <?php } ?>		    
		...
		$fileUploadDir = base_url().'/uploads/'.$currentYear.'/RA/'.$user['user_id'];
            ...
            <?php //echo $userdata['role']; 
	           //echo $editdata['is_rate_submitted'];		
    if($userdata['role'] == 1 && $editdata['is_rate_submitted'] == 0): ?>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel xpanelform">
                      ...
                      <input type="hidden" name="nominee_id" value="<?=(isset($user['user_id']))?$user['user_id']:"";?>"  >
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input type="text" id="rating" name="rating" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('rating',((isset($editdata['rating']) && !empty($editdata['rating']))?$editdata['rating']:""));?>">
                                    </div>
                                  </div>
                                  <div class="clearfix"></div>
