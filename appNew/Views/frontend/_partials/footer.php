        ...
        <div class="container py-4 py-lg-5">
            <div class="row justify-content-center">
                ...
                <div class="col-sm-12 col-md-3 text-center text-lg-start d-flex flex-column item" style="font-size: 14px;">
                    ...
                    <li style="color: var(--bs-white);font-size: 14px;"><a class="dropdown-item" href="<?=base_url();?>/research_awards">Research Awards</a></li>
                    <li style="color: var(--bs-white);font-size: 14px;"><a class="dropdown-item" href="<?=base_url();?>/latest_winners_of_research_awards">Latest Winners Of Research Awards<br></a></li>
                    <li style="color: var(--bs-white);font-size: 14px;"><a class="dropdown-item" href="<?=base_url();?>/science_scholar_awards">Scholar Awards</a></li>
                    <li style="color: var(--bs-white);font-size: 14px;"><a class="dropdown-item" href="<?=base_url();?>/latest_winners_of_science_scholar_awards">Latest Winners Of Scholar Awards</a></li>
                ...
                <div class="col-sm-12 col-md-4 text-center text-lg-start d-flex flex-column item" style="font-size: 14px;">
                    ...
                    <li style="font-size: 14px;color: var(--bs-gray-100);"><a class="dropdown-item" href="<?=base_url();?>/special_awards">Special Award In Public Health</a></li>
                  </ul>
                </div>
            </div>
            <hr>
