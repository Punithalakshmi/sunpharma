                ...
                <div class="col-md-6">
                    <ul class="list-group btnaction" style="max-width: 400px;border-color: var(--bs-blue);">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor" style="font-size: 29px;color: var(--theme-orange);">
                            ...
                            <a href="<?=base_url();?>/frontend/assets/documents/Scope%20of%20the%20Award.pdf" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;" target="_blank">Scope Of Each Award</a></li>
                        <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);">
                            ...
                            <a href="<?=base_url();?>/frontend/assets/documents/RA_Nomination_2021.doc" style="margin-left: 15px;color: var(--bs-blue);font-size: 20px;" target="_blank">Nomination Procedure</a></li>
                        <li class="list-group-item" style="font-size: 20px;border-color: var(--bs-blue);">
