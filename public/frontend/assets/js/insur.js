(function ($) {
  "use strict";
  if ($(".get-sunpharma__progress-range").length) {
    $(".get-sunpharma__progress-range").each(function () {
      let balanceTag = $(this).find(".get-sunpharma__balance span");
      let balanceInput = $(this).find(".get-sunpharma__balance__input");
