...
namespace RectorPrefix20220609\Symplify\Astral\NodeAnalyzer;

use RectorPrefix20220609\Nette\Application\UI\Template;
use PhpParser\Node\Expr;
use PhpParser\Node\Expr\PropertyFetch;
use PHPStan\Analyser\Scope;
use RectorPrefix20220609\Symplify\Astral\Naming\SimpleNameResolver;
use RectorPrefix20220609\Symplify\Astral\TypeAnalyzer\ContainsTypeAnalyser;
/**
 * @api
 */
final class NetteTypeAnalyzer
{
     ...
     */
    private const TEMPLATE_TYPES = ['RectorPrefix20220609\\Nette\\Application\\UI\\Template', 'RectorPrefix20220609\\Nette\\Application\\UI\\ITemplate', 'RectorPrefix20220609\\Nette\\Bridges\\ApplicationLatte\\Template', 'RectorPrefix20220609\\Nette\\Bridges\\ApplicationLatte\\DefaultTemplate'];
    /**
    ...
    public function isInsideComponentContainer(Scope $scope) : bool
    {
        ...
        // this type has getComponent() method
        return \is_a($className, 'RectorPrefix20220609\\Nette\\ComponentModel\\Container', \true);
    }
    public function isInsideControl(Scope $scope) : bool
    {
        ...
        return \is_a($className, 'RectorPrefix20220609\\Nette\\Application\\UI\\Control', \true);
    }
}
