...
class Command
{
    ...
    public static function getDefaultName() : ?string
    {
        ...
        \RectorPrefix20220609\trigger_deprecation('symfony/console', '6.1', 'Relying on the static property "$defaultName" for setting a command name is deprecated. Add the "%s" attribute to the "%s" class instead.', AsCommand::class, static::class);
    ...
    public static function getDefaultDescription() : ?string
    {
        ...
        \RectorPrefix20220609\trigger_deprecation('symfony/console', '6.1', 'Relying on the static property "$defaultDescription" for setting a command description is deprecated. Add the "%s" attribute to the "%s" class instead.', AsCommand::class, static::class);
    ...
    public function run(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (null !== $this->processTitle) {
            ...
            } elseif (\function_exists('RectorPrefix20220609\\setproctitle')) {
